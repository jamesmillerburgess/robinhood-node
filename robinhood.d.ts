...
declare function robinhood(
  options: robinhood.Options.WebApiOpts,
  callback: robinhood.InitCallback
): robinhood.RobinhoodWebApi;
...
declare namespace robinhood {
  ...
  export type TagTypes = "10-most-popular" | "100-most-popular";

  export type TriggerTypes = "immediate" | "day";

  export type TimeInForceTypes = "gfd" | "gtc" | "oco";

  export type OrderTypes = "limit" | "market";

  export type IntervalTypes = "5minute" | "10minute";

  export type SpanTypes = "week" | "day";
  ...
  export interface RobinhoodWebApi {
     ...
     */
    place_buy_order(
      options: Options.BuySellOptions,
      callback: request.RequestCallback
    ): void;
    ...
    earnings(
      options:
        | Options.EarningsOptionsWithInstrument
        | Options.EarningsOptionsWithSymbol,
      callback: request.RequestCallback
    ): void;
